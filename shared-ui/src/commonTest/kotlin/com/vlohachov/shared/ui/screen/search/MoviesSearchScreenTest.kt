        ...
        MoviesPotTheme {
            MoviesSearch(
                ...
                viewModel = MoviesSearchViewModel(
                    pager = MoviesSearchPager(useCase = searchMovies, debounce = debounce)
                ),
